...
- The response of crust to stress perturbations (e.g. earthquakes, volcano activities, tides).
- Wave properties of noise correlations.
- Noise-based passive ballistic wave monitoring.
